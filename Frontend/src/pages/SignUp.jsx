    ...
    return (
        <div className='bg-green-700 min-h-screen relative'>
            ...
            <div className="absolute inset-y-0 right-0 w-1/2 bg-white p-8 rounded-l-3xl shadow-md">
                <div className="flex flex-col justify-center pt-32 px-16 p-4 text-4xl font-bold">Daftar</div>
                <form action="#">
                    ...
                    <Link to='/src/pages/SignIn.jsx' type="submit" className="px-16 py-3 item-center text-white bg-primary-700 font-normal rounded-lg block w-full p-4 text-lg dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-500">Daftar</Link>
                    </div>
