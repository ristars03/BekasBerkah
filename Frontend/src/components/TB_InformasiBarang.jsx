    ...
    <div className="w-[1444px] relative mt-8 p-8 bg-white rounded-lg border gap-2 border-zinc-200 mx-auto ">
      ...
      <div className="flex items-start justify-between">
        <div className="w-[340px] px-4 text-align text-zinc-700">
          Nama barang min 40 karakter dengan memasukkan merek, jenis produk,
        ...
        <div className="flex-grow px-10 mt-[-32px] mb-8">
          <input
            ...
            placeholder="Contoh : Sepatu nike mercurial CR7 Pemakaian normal selama lima tahun"
            value={itemName}
            onChange={(e) => setItemName(e.target.value)}
          />
          <div className="text-xs text-gray-400 py-3">
            Tips : Nama barang + Merek barang + Keterangan pemakaian
          </div>
        </div>
      </div>
      <div className="flex items-center">
      ...
      <div className="flex items-start justify-between ">
        <div className="w-[340px] px-4 text-align text-zinc-700">
          Pilih kategori yang sesuai dengan barang yang anda jual.
        </div>
        <div className="flex-grow px-10 mt-[-32px]">
          <select
            name="category"
            id="category"
            className="w-full outline-none rounded-lg border border-zinc-200 px-2 py-4"
            value={category}
