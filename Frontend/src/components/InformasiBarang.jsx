    ...
    return (
        <div className='w-[1444px] relative mt-8 p-8 bg-white rounded-lg border gap-2 border-zinc-200 mx-auto '>
            ...
            <div className="flex items-start justify-betwee ">
                <div className="w-[340px] px-4 text-justify text-zinc-700">Nama barang min 40 karakter dengan memasukkan merek, jenis produk, warna, bahan atau tipe.</div>
            ...
            <div className="flex items-start justify-betwee ">
                <div className="w-[340px] px-4 text-justify text-zinc-700">Pilih kategori yang sesuai dengan barang yang anda jual.</div>
                <div className="flex-grow px-10">
