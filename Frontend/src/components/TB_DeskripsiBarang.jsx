  ...
  return (
    <div className="w-[1444px] relative mt-8 p-8 bg-white rounded-lg border gap-2 border-zinc-200 mx-auto ">
      ...
      <div className="flex items-center">
        <div className="px-4 py-2 text-zinc-700 font-bold">
          Deskripsi Barang
        </div>
      ...
      <div className="flex items-start justify-between ">
        ...
        <div className="flex-grow px-10 mt-[-32px] mb-8 mx-auto">
          <textarea
            type="text"
            className="border border-gray-300 rounded-lg w-full p-8"
            placeholder=""
            rows="2"
      ...
      <div className="flex items-start ">
        <div className="w-[340px] px-4 text-align text-zinc-700">
          Tambah video agar pembeli semakin tertarik dengan barang yang anda
          jual.
        </div>
        <div className="px-10 mt-[-32px]">
          {!videoFile ? (
            ...
            <div className="border border-lg border-gray-300 text-gray-400 rounded-md flex px-2 gap-2 h-10 items-center ">
              ...
              <button onClick={handleVideoDelete} className="text-red-500">
                Delete
              </button>
            </div>
          )}
